...
##### Prompt: *"A bustling futuristic city with advanced transportation systems—magnetic levitation trains gliding through transparent sky rails, autonomous electric cars on elevated roads, flying taxis zooming between skyscrapers. Neon lights illuminate the streets below, and holographic traffic signs float in the air. The scene is set during twilight, with a cyberpunk aesthetic and cinematic lighting."* Generated with Runway AI
![Gen4 A bustling futuristic city with advanced transportation systems—magnetic levitatio a-2, 7597906](https://github.com/user-attachments/assets/42bde38b-8e5f-4c63-aa1e-49a0ea43600a)

##### Prompt: *"A bustling futuristic city with advanced transportation systems—magnetic levitation trains gliding through transparent sky rails, autonomous electric cars on elevated roads, flying taxis zooming between skyscrapers. Neon lights illuminate the streets below, and holographic traffic signs float in the air. The scene is set during twilight, with a cyberpunk aesthetic and cinematic lighting."* Generated with Gemini ai
![Gemini_Generated_Image_1gqtjq1gqtjq1gqt](https://github.com/user-attachments/assets/fb91b8d3-c08a-4a8c-8874-00c89b45de42)
